          ...
          level: (calculateBadgeWithCriteria(
            {
              ...
              haki: u.haki ?? null,
              nib: u.nib ?? null,
              whatsapp: (u as Record<string, string | null>).whatsapp ?? null,
            ...
            latestMap[u.id]
              ? {
                  ...
                  whatsapp: (latestMap[u.id] as Record<string, string | null>).whatsapp ?? ((u as Record<string, string | null>).whatsapp ?? null),
